...
// המקור: "לוח אירועים" שבתוסף "ביוגרפיות v2.2.3.otzplugin" (window.EVENTS ב-
// data/events-data.js), רק הרשומות שתויגו שם category:"תנ״ך" - 37 מתוך 46.
...
// שתואר בהערה של הכותב). 2.10ב (סריקת כל התנ״ך אחר תאריכים - עבודת מחקר,
// אינה בסבב הזה) יוסיף עוד רשומות לאותו מערך TANAKH_DATE_EVENTS, בלי שינוי
// מבנה: כל צרכני הדאטה (eventsForToday, הפאנל ב-home.js) קוראים מהמערך עצמו.
