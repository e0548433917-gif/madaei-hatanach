...
4. **סמוק ידני — 8 מסלולים:** פתיחת שער · פתיחת כל אחד מ-6 המדריכים · חיפוש בתוך מדריך + צ׳יפים · פתיחת כרטיס (כולל אישים עם קישורי משפחה ומקומות עם מפה) · לחיצה על פסוק ← נפתח בספרייה · טופס עריכה: שמירה מקומית + שחזור למקור · ״זהה בתמונ״ך״ מהספרייה ← תוצאות (בדיקת באג 996) · הגדרות תצוגה: החלפת ערכה/גופן/גודל + איפוס.
